...
const TESTIMONIALS = [
  { name: 'Chioma Okafor', role: 'Medical Student, UNILAG', rating: 5, text: 'StudyPilot completely transformed how I prepare for exams. The AI timetable actually fits my real schedule and the readiness score keeps me accountable.', avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=80&q=80&fit=crop&crop=face' },
  { name: 'Emeka Nwachukwu', role: 'Engineering Student, OAU', rating: 5, text: 'I went from failing two courses to making Dean\'s List in one semester. The AI knows exactly how much time I need and adjusts when I fall behind.', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&q=80&fit=crop&crop=face' },
  { name: 'Fatima Al-Hassan', role: 'Law Student, ABU', rating: 5, text: 'The analytics are incredible. I can see exactly where I spend study time and the AI gives weekly insights. Worth every single naira.', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=80&q=80&fit=crop&crop=face' },
]
...
const scaleIn = { hidden: { opacity: 0, scale: .93 }, show: { opacity: 1, scale: 1, transition: { duration: .5, ease: [.22, 1, .36, 1] } } }
...
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   SHARED COMPONENTS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
function Btn({ children, onClick, outline = false, white = false, sm = false, className = '' }: any) {
  ...
  const variant = white
    ...
    : outline
      ...
      : 'bg-gradient-to-r from-purple-600 to-purple-700 text-white btn-glow hover:from-purple-700 hover:to-purple-800'
  return (
    <motion.button whileHover={{ scale: 1.025, y: -1 }} whileTap={{ scale: .97 }}
      onClick={onClick} className={`${base} ${variant} ${className}`}>
      {children}
    </motion.button>
  )
}
...
function Logo({ onClick }: { onClick?: () => void }) {
  return (
    <button onClick={onClick} className="flex items-center gap-2.5">
      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-600 to-pink-500 flex items-center justify-center shadow-purple-sm">
      ...
      <motion.nav initial={{ y: -56, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: .5 }}
        ...
        <div className="max-w-6xl mx-auto px-6 h-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Btn onClick={() => setPage('signup')} sm>Get Started Free</Btn>
          </div>
      ...
      <AnimatePresence>
        {open && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }}
            className="fixed top-16 inset-x-0 z-40 bg-white border-b border-gray-100 overflow-hidden">
            <div className="p-5 space-y-3">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <Btn onClick={() => { setPage('signup'); setOpen(false) }} className="w-full">Get Started Free</Btn>
              </div>
            </div>
          </motion.div>
        )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <motion.div variants={stagger(.1)} initial="hidden" animate="show" className="max-w-xl">
              ...
              <motion.h1 variants={fadeUp}
                className="text-5xl lg:text-[56px] font-black text-gray-900 leading-[1.08] tracking-tight mb-5">
                Your AI-Powered<br />
                <span className="grad">Study Planner</span>
              </motion.h1>
            ...
            <motion.div initial={{ opacity: 0, y: 40, scale: .96 }} animate={{ opacity: 1, y: 0, scale: 1 }}
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_24px_80px_rgba(0,0,0,.12)] overflow-hidden">
                  ...
                  <div className="p-5 bg-gradient-to-br from-purple-50/30 to-white">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="bg-purple-600 text-white text-[10px] font-bold px-3 py-1.5 rounded-lg shadow-purple-sm">+ New Plan</div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-3 border border-gray-100 mb-3">
                      <p className="text-[10px] font-bold text-gray-600 mb-2.5">Subject Progress</p>
                      {[['Mathematics', 75, '#7c3aed'], ['Physics', 50, '#db2777'], ['Chemistry', 35, '#6d28d9']].map(([s, p, c]) => (
                        <div key={s as string} className="mb-2">
                          <div className="flex justify-between text-[9px] mb-1"><span className="text-gray-600 font-medium">{s}</span><span className="text-gray-400">{p}%</span></div>
                          <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <motion.div initial={{ width: 0 }} animate={{ width: `${p}%` }} transition={{ duration: 1, delay: .9, ease: 'easeOut' }}
              ...
              <motion.div initial={{ opacity: 0, scale: 0, x: 20 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ delay: 1, type: 'spring', bounce: .4 }}
                className="absolute -top-5 -right-5 bg-white rounded-2xl shadow-card-hover border border-gray-100 px-4 py-2.5 flex items-center gap-2">
              ...
              <motion.div initial={{ opacity: 0, scale: 0, x: -20 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ delay: 1.2, type: 'spring', bounce: .4 }}
                className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-card-hover border border-gray-100 px-4 py-2.5 flex items-center gap-2">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            ...
            {[
              ...
              { n: '02', icon: '🤖', title: 'A Generate Plan', desc: 'AI calculates your optimal timetable — weighted by urgency, difficulty, and time.' },
              ...
              <Reveal key={i} delay={i * .12}>
                <motion.div whileHover={{ y: -4, boxShadow: '0 12px 36px rgba(124,58,237,.1)' }}
                  className="bg-white border border-gray-100 rounded-2xl p-8 text-center shadow-card transition-all duration-300 group">
            ...
            {FEATURES.map((f, i) => (
              <Reveal key={i} delay={i * .08}>
                <motion.div whileHover={{ y: -4, boxShadow: '0 12px 36px rgba(124,58,237,.1)', borderColor: '#e9d5ff' }}
                  className="bg-white border border-gray-100 rounded-2xl p-7 shadow-card cursor-default group transition-all duration-300">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 flex items-center justify-center text-2xl mb-5 group-hover:scale-110 transition-transform duration-300">
                    {f.icon}
                  </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl overflow-hidden shadow-2xl">
              <div className="bg-white/5 border-b border-white/15 px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-bold text-sm">Good morning, Amaka! 👋</p>
                    <p className="text-purple-200 text-xs">Here's your study overview for today</p>
                  </div>
                </div>
                <div className="hidden md:flex items-center gap-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={i} className={`rounded-xl p-4 border ${item.done ? 'bg-white/10 border-white/20' : 'bg-white/5 border-white/10'}`}>
                        ...
                        {item.tasks.map(t => (
                          <p key={t} className="text-purple-200 text-xs py-0.5">{t}</p>
                        ))}
                      </div>
                    ))}
                  </div>
            ...
            {TESTIMONIALS.map((t, i) => (
              <Reveal key={i} delay={i * .1}>
                <motion.div whileHover={{ y: -5, boxShadow: '0 16px 48px rgba(124,58,237,.12)', borderColor: '#e9d5ff' }}
                  className="bg-white border border-gray-100 rounded-2xl p-6 shadow-card transition-all duration-300 flex flex-col h-full">
                  <Stars n={t.rating} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <Reveal delay={.1}>
              <motion.div whileHover={{ y: -4 }}
                className="bg-white border border-gray-200 rounded-2xl p-8 shadow-card transition-all duration-300 h-full flex flex-col">
            ...
            <Reveal delay={.2}>
              <motion.div whileHover={{ y: -4 }} className="relative h-full flex flex-col">
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10">
                  <div className="bg-gradient-to-r from-purple-600 to-pink-500 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-purple-sm">Most Popular</div>
                </div>
                <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-8 shadow-purple-lg flex-1 flex flex-col">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <Reveal>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-4 leading-tight tracking-tight">
              Ready to Transform Your<br />Study Routine?
            </h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
              ...
              <div className="flex gap-2">
                {['T', 'L', 'I', 'G'].map((s, i) => (
                  <motion.a key={i} href="#" whileHover={{ scale: 1.1, background: '#f3e8ff' }}
                    className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400 text-xs font-bold transition-colors">
                    {s}
                  </motion.a>
                ))}
              </div>
            ...
            {[
              ...
              { title: 'Report', links: ['Privacy', 'Terms', 'Cookies', 'Contact'] },
            ].map(col => (
              <div key={col.title}>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-6">
      <motion.div initial={{ opacity: 0, y: 28, scale: .97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: .5, ease: [.22, 1, .36, 1] }}
        ...
        <div className="p-8 md:p-10">
          <button onClick={() => setPage('home')} className="flex items-center gap-2 text-gray-400 hover:text-purple-600 text-sm font-medium mb-6 transition-colors group">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:-translate-x-1 transition-transform"><path d="M19 12H5M12 5l-7 7 7 7" /></svg>
            Back to home
          </button>
          <Logo onClick={() => setPage('home')} />
          ...
          <form onSubmit={submit} className="space-y-4">
            {[
              ...
              <div key={field.key}>
                ...
                <input type={field.type} placeholder={field.ph} value={f[field.key as keyof typeof f]}
            ...
            <motion.button type="submit" whileHover={{ scale: 1.01 }} whileTap={{ scale: .98 }} disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold py-3.5 rounded-xl text-sm shadow-purple-md disabled:opacity-60 flex items-center justify-center gap-2 mt-1">
          ...
          <p className="text-center text-gray-400 text-sm mt-6">
            No account?{' '}
            <button onClick={() => setPage('signup')} className="text-purple-600 font-bold hover:text-purple-700">Create one free →</button>
          </p>
        </div>
      </motion.div>
    </div>
      ...
      <motion.div initial={{ opacity: 0, y: 28, scale: .97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: .5, ease: [.22, 1, .36, 1] }}
        ...
        <div className="p-8 md:p-10">
            ...
            <div>
              ...
              {f.password && (
                <div className="mt-2 space-y-1">
                  ...
                  <p className={`text-xs ${str === 1 ? 'text-red-400' : str === 2 ? 'text-amber-400' : 'text-green-500'}`}>
                    {['', 'Weak', 'Good', 'Strong'][str]} password
                  </p>
                </div>
              )}
          ...
          <p className="text-center text-gray-300 text-xs mt-4">
            By signing up you agree to our <a href="#" className="text-purple-600">Terms</a> & <a href="#" className="text-purple-600">Privacy</a>
          </p>
...
function LogoutPage({ setPage }: { setPage: (p: string) => void }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-6">
      <motion.div initial={{ opacity: 0, y: 24, scale: .97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: .5, ease: [.22, 1, .36, 1] }} className="text-center">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-600 to-pink-500 flex items-center justify-center mx-auto mb-6 shadow-purple-lg">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" /></svg>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-6">
      <motion.div initial={{ opacity: 0, y: 28, scale: .97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: .5, ease: [.22, 1, .36, 1] }}
        ...
        <div className="h-1 bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600" />
        <div className="p-8 md:p-10">
          <button onClick={() => setPage('login')} className="flex items-center gap-2 text-gray-400 hover:text-purple-600 text-sm font-medium mb-8 transition-colors group">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:-translate-x-1 transition-transform"><path d="M19 12H5M12 5l-7 7 7 7" /></svg>
            Back to login
          </button>
          {!sent ? (
            <>
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <motion.button type="submit" whileHover={{ scale: 1.01 }} whileTap={{ scale: .98 }} disabled={loading}
                  className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold py-3.5 rounded-xl text-sm shadow-purple-md disabled:opacity-60 flex items-center justify-center gap-2">
...
interface OverviewTabProps {
  ...
  setTab: (tab: 'overview' | 'planner' | 'tasks' | 'analytics') => void;
  loading: boolean;
}
...
function OverviewTab({ tasks, setTasks, setTab, loading }: OverviewTabProps) {
  const bars = [['M', 60], ['T', 40], ['W', 85], ['T', 30], ['F', 100], ['S', 65], ['S', 50]]
  return (
    <div className="max-w-5xl mx-auto space-y-5">
      {/* Stats */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {loading ? (
          Array(4).fill(0).map((_, i) => <div key={i} className="bg-white rounded-2xl p-5 border border-gray-100 skeleton h-28" />)
        ) : (
          [
            ...
            <motion.div key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0, transition: { delay: i * .07 } }}
              className={`bg-white rounded-2xl p-5 border ${s.border} shadow-card hover:shadow-card-hover transition-all`}>
            ...
            <div className="space-y-3">
              {tasks.map((task, i) => (
                <motion.div key={task.id} layout
                  className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 group transition-colors cursor-default">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-semibold flex-shrink-0 ${task.priority === 'high' ? 'bg-red-50 text-red-500' :
...
function PlannerTab() {
  ...
  async function generate(e: React.FormEvent) {
    ...
    setPlan(days.map(day => ({
      day,
      sessions: valid.slice(0, 2).map((s, i) => ({
        subject: s,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5">
                ...
                <div key={i} className="flex gap-2">
                  ...
                  {subjects.length > 1 && (
                    <button
                      ...
                      className="w-10 h-10 rounded-xl border border-red-200 bg-red-50 text-red-400 hover:bg-red-100 flex items-center justify-center text-sm transition-colors"
                    >
                      ✕
                    </button>
                  )}
      ...
      <Btn className="w-full py-3.5 text-base">
        {loading
    ...
    <AnimatePresence>
      {loading && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
          className="bg-white rounded-2xl p-12 border border-purple-100 shadow-card flex flex-col items-center gap-4 text-center">
      ...
      <AnimatePresence>
        {showForm && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
            <div className="bg-white rounded-2xl p-6 border border-purple-100 shadow-card">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e => setNt({ ...nt, subject: e.target.value })}
                      className="w-full px-3 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm outline-none focus:border-purple-400 transition-all"
                    />
                  </div>
                </div>
        ...
        <AnimatePresence>
          {filtered.length === 0 ? (
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0, transition: { delay: i * .04 } }}
              exit={{ opacity: 0, x: -20 }}
              className="bg-white rounded-2xl p-5 border border-gray-100 shadow-card flex items-center gap-4 group hover:shadow-card-hover transition-all"
            >
              <button
              ...
              <span className={`text-xs px-2.5 py-1 rounded-full font-semibold flex-shrink-0 ${task.priority === 'high' ? 'bg-red-50 text-red-500' :
                task.priority === 'medium' ? 'bg-amber-50 text-amber-500' :
                  'bg-green-50 text-green-600'
                }`}>
                {task.priority}
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 p-2 rounded-lg text-gray-300 hover:text-red-400 hover:bg-red-50 transition-all"
              >
                ✕
              </button>
            </motion.div>
...
function AnalyticsTab() {
  return (
    <div className="max-w-4xl mx-auto space-y-5">
      <div>
        <h2 className="font-black text-gray-900 text-xl tracking-tight">Analytics</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[['89h', 'Total Hours', '#7c3aed'], ['12 days', 'Study Streak', '#db2777'], ['3.2h', 'Avg Daily', '#059669'], ['47', 'Tasks Done', '#d97706']].map(([v, l, c], i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0, transition: { delay: i * .07 } }}
            ...
            <div className="w-8 h-8 rounded-lg mb-3" style={{ background: `${c}18` }}>
        ...
        <div className="flex items-end gap-3 h-36">
          {[[14, 'W1'], [18, 'W2'], [12, 'W3'], [22, 'W4'], [19, 'W5'], [25, 'W6']].map(([h, label], i) => (
            <div key={i} className="flex-1 flex flex-col items-center gap-2">
              <motion.div
                initial={{ height: 0 }}
                animate={{ height: `${(Number(h) / 25) * 100}%` }}
                transition={{ duration: .65, delay: i * .1, ease: 'easeOut' }}
                className="w-full rounded-t-xl"
                style={{ background: i === 5 ? 'linear-gradient(to top,#7c3aed,#db2777)' : '#f3e8ff' }}
              />
          ...
          {[
            ...
            <div key={i}>
              ...
              <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: `${exam.pct}%` }}
                  transition={{ duration: .9, delay: i * .15 }}
                  className="h-full rounded-full"
                  style={{ background: exam.c }}
                />
              </div>
...
function Pricing({ setPage }: { setPage: (p: string) => void }) {
  ...
  const faqs = [
    { q: 'Can I cancel anytime?', a: 'Yes! No contracts, no penalties. Cancel from your account settings and keep access until your billing period ends.' },
    { q: 'Is the free plan really free forever?', a: 'Yes — free forever with no credit card required. The free plan includes 3 subjects and 3 AI plans per month.' },
    { q: 'How does the AI generate my plan?', a: 'You enter your subjects, exam dates, and available hours. The AI calculates the optimal schedule and builds a day-by-day timetable in seconds.' },
    { q: 'Do you support Paystack?', a: 'Yes! Paystack is fully supported for Nigerian users — card, bank transfer, and USSD. All prices shown in your local currency.' },
    { q: "What's the 7-day free trial?", a: 'When you sign up for Pro, you get full Pro access free for 7 days. No charge until the trial ends. Cancel any time before it does.' },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-28 pb-16 px-6 text-center bg-gradient-to-b from-purple-50/40 to-white relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-purple-100/40 blur-[100px]" />
        </div>
        <motion.div initial="hidden" animate="show" variants={stagger(.1)} className="relative z-10">
          ...
          <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">
      ...
      <section className="pb-20 px-6">
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          <Reveal delay={.1}>
            <motion.div whileHover={{ y: -4 }} className="bg-white border border-gray-200 rounded-2xl p-8 shadow-card h-full flex flex-col transition-all">
          ...
          <Reveal delay={.18}>
            <motion.div whileHover={{ y: -4 }} className="relative h-full flex flex-col">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10">
                <div className="bg-gradient-to-r from-purple-600 to-pink-500 text-white text-xs font-black px-5 py-1.5 rounded-full shadow-purple-sm">Most Popular</div>
              </div>
              <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-8 shadow-purple-lg flex-1 flex flex-col">
            ...
            {faqs.map((faq, i) => (
              <Reveal key={i} delay={i * .06}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full text-left bg-white border border-gray-100 rounded-2xl px-6 py-5 shadow-card hover:border-purple-100 hover:shadow-card-hover transition-all">
      ...
      <section className="pb-20 px-6">
        <Reveal>
          <div className="max-w-2xl mx-auto text-center bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded-2xl p-12 shadow-card">
